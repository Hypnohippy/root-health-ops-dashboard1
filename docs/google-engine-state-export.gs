...
function opsExportEngineState() {
  ...
  config.sheets.forEach(function(mapping) {
    ...
    var required = [mapping.id_header].concat(Object.values(mapping.fields || {}), Object.values(mapping.state || {}), Object.values(mapping.safety || {}));
    ...
    rows.slice(1).forEach(function(row) {
      ...
      function read(header) { return row[headers.indexOf(header)]; }
