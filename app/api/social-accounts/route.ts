...
  // IMPORTANT:
  // Do NOT force all users into SINGLE_ORG_ID here.
  // For subscriber accounts we must use their real organisation membership.
  return getLatestMembershipOrgId(userId);
}
