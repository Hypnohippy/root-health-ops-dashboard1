...
if (usage + cost > monthlyLimit) {
  ...
  "",
  "CRITICAL:",
  "The tone, examples, and explanations MUST adapt based on the learner audience and delivery context.",
  "",
  ...
  "  Use CPD-style tone.",
  "  Include reflective practice, facilitation insight, and deeper conceptual understanding.",
  "",
  "- If audience is peer groups:",
  "  Use supportive, shared-experience tone.",
  "  Avoid hierarchy or expert language.",
  "",
  "",
  "DELIVERY STYLE RULES:",
  "- Always explain concepts clearly — do not just say 'introduce' or 'discuss'.",
  "- Provide actual teaching content, not placeholders.",
  "- Include examples, scripts, or explanations where relevant.",
