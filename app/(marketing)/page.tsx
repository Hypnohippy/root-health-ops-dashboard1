      ...
      <main className="mx-auto max-w-6xl px-4 py-12 md:py-16 space-y-12">
        <section className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight leading-[1.05]">
              ...
              <span className="text-emerald-300"> without becoming a marketing machine.</span>
            </h1>

            <p className="text-base md:text-lg text-slate-300 leading-relaxed">
              Root Health Ops helps you show up consistently, protect your energy,
              and grow your practice in a way that still feels like <span className="text-slate-100 font-semibold">you</span>.
              Less admin. Less “selling”. More steady momentum.
            </p>
            ...
            <div className="text-[12px] text-slate-400 leading-relaxed">
              This isn’t “ad spam”. It’s a values-led system for visibility — so your clients can find you,
              and you can keep your focus where it belongs.
            </div>
          </div>

          {/* Right side: calm feature snapshot */}
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-6 md:p-8 shadow-[0_30px_120px_rgba(0,0,0,0.45)]">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="mt-1 text-xs text-slate-300">
                  Simple, real features already inside your dashboard.
                </div>
              </div>
              <Pill>Live</Pill>
            </div>
            ...
            <div className="mt-6 grid gap-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <div className="mt-1 text-[13px] text-slate-300">
                  Queue posts in advance so your visibility stays consistent.
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <div className="mt-1 text-[13px] text-slate-300">
                  Turn your ideas into posts you can edit, then send now or schedule.
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <div className="mt-1 text-[13px] text-slate-300">
                  A quiet place to shape your message and stay aligned to your values.
                </div>
              </div>
            </div>

            <div className="mt-6 text-[12px] text-slate-400">
              Next: we’ll add a short “demo” area so you can embed your videos.
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <Card title="Built for the human reality">
            ...
            less friction, and a system that supports them when energy is low.
          </Card>

          <Card title="Visibility without pressure">
            You don’t have to become someone else to grow. We focus on calm, ethical
            consistency — not hype, not hustle, not spam.
          </Card>

          <Card title="Designed to protect your focus">
            The goal is simple: let the platform do the repetitive work, so you can
            stay present with clients — and still build momentum.
          </Card>
        </section>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
            <div>
              <div className="text-2xl md:text-3xl font-semibold tracking-tight">
                Ready to make this marketable?
              </div>
              <p className="mt-2 text-sm text-slate-300 leading-relaxed">
                Next we’ll fill the <span className="text-slate-100 font-semibold">How it works</span>,{" "}
                <span className="text-slate-100 font-semibold">Pricing</span>, and{" "}
                <span className="text-slate-100 font-semibold">Colleges</span> pages — with clear, compassionate copy
                and a simple journey that converts without feeling salesy.
              </p>
            </div>
